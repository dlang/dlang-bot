...
{
    setAPIExpectations(
        "/github/repos/dlang/dmd/issues?state=open&labels=auto-merge,auto-merge-squash", (ref Json j) {
            j = Json.emptyArray;
        }
    );
...
unittest
{
    ...
    setAPIExpectations(
        "/github/repos/dlang/dmd/issues?state=open&labels=auto-merge,auto-merge-squash",
...
unittest
{
    ...
    setAPIExpectations(
        "/github/repos/dlang/dmd/issues?state=open&labels=auto-merge,auto-merge-squash", (ref Json j) {
            j[0]["labels"][1]["name"] = "auto-merge-squash";
        },
        "/github/repos/dlang/dmd/pulls/6327/commits",
        "/github/repos/dlang/dmd/pulls/6327/merge",
        (scope HTTPServerRequest req, scope HTTPServerResponse res){
